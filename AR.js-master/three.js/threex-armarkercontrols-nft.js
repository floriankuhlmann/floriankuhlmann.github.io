...
THREEx.ArMarkerControls = function(context, object3d, parameters){
	...
	this.parameters = {
		...
		// url of the pattern - IIF type='nft'
		nftUrl : parameters.nftUrl !== undefined ? parameters.nftUrl : null,
...
THREEx.ArMarkerControls.prototype._postInit = function() {
	...
	arController.addEventListener('getMarker', function(event){
		...
		if( event.data.type === artoolkit.PATTERN_MARKER && _this.parameters.type === 'pattern' ){
			...
			onMarkerFound()
		}else if( event.data.type === artoolkit.UNKNOWN_MARKER && _this.parameters.type === 'nft'){
			console.log("96 parameter type:"+_this.parameters.type);
			onMarkerFound()
		}
